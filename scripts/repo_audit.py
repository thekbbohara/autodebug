...
def init_audit(audit_id, repo_path, repo_name=""):
    ...
    state = {
        ...
        "phases": {
            "0_business_logic": {"status": "pending", "description": "Discover business logic, infer rules, confirm with user before scanning"},
            ...
            "6_logic_bugs": {"status": "pending", "description": "Business logic violations, unhandled exceptions, race conditions, missing awaits"},
